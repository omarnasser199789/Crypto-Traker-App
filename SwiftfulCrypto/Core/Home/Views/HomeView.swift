    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                homeHeader
                HomeStateView(showProtfolio: $showPortfolio)
        ...
        HStack{
            ...
            HStack(spacing: 4){
                ...
                Image(systemName: "chevron.down")
                    .opacity((vm.sortOption == .rank || vm.sortOption == .reankReversed) ? 1.0 : 0.0 )
                    .rotationEffect(Angle(degrees: vm.sortOption == .rank ? 0 : 180))
                            }
            .onTapGesture {
                withAnimation(.default){
                    vm.sortOption = vm.sortOption == .rank ? .reankReversed : .rank
                }
            }
